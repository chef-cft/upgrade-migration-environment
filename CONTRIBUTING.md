...
1. **Tests:** To ensure high quality code and protect against future regressions, we require all the code in Chef Projects to have at least unit test coverage.
2. **Green CI Tests:** We use [Jenkins](https://jenkins.io) to test all pull requests. We require these test runs to succeed on every pull request before being merged.
**NOTE: These have not yet been setup for this repository**
